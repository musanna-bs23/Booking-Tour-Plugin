...
class BookingTour {
    ...
    public function __construct() {
        ...
        // Shortcodes
        add_shortcode('multipurpose_hall_booking', array($this, 'render_hall_shortcode'));
        add_shortcode('knowledge_hub_tours', array($this, 'render_tours_shortcode'));
    ...
    // Shortcode: Multipurpose Hall Booking
    public function render_hall_shortcode($atts) {
        global $wpdb;
        $type = $wpdb->get_row("SELECT * FROM {$wpdb->prefix}bt_booking_types WHERE type_category = 'hall'");
        ...
        ob_start();
        ?>
        <div class="bt-booking-container" data-mode="hall">
            <div class="bt-header">
                ...
                <h2 class="bt-title">Multipurpose Hall Book</h2>
                <p class="bt-subtitle">Select a date and time slots to book the multipurpose hall</p>
            </div>

            <input type="hidden" id="bt-type-id" value="<?php echo esc_attr($type->id); ?>">
    ...
    public function render_tours_shortcode($atts) {
        ...
        if (!$event_type || !$individual_type) {
            return '<p>Booking system is not configured properly.</p>';
        }
        
        ob_start();
        ?>
        <div class="bt-booking-container" data-mode="tours">
            <div class="bt-header">
                <div class="bt-header-icon">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                        <circle cx="12" cy="12" r="10"></circle>
                ...
                <h2 class="bt-title">Knowledge Hub Exhibition Tours</h2>
                <p class="bt-subtitle">Book a tour of the Knowledge Hub</p>
            </div>

            <div class="bt-tour-selector">
                <button class="bt-tour-btn active" data-type-id="<?php echo esc_attr($individual_type->id); ?>" data-category="individual_tour">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" width="20" height="20">
                ...
                <button class="bt-tour-btn" data-type-id="<?php echo esc_attr($event_type->id); ?>" data-category="event_tour">
				 ...
				 <button class="bt-tour-btn" onclick="window.location.href='http://35.240.207.116/knowledgehub/wordpress/?page_id=1611';">
                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" width="20" height="20">
						<!-- Roof -->
                    ...
                    <span>Multipurpose Hall Booking</span>
                </button>
            ...
            <input type="hidden" id="bt-type-id" value="<?php echo esc_attr($individual_type->id); ?>">
            <input type="hidden" id="bt-type-category" value="individual_tour">
            ...
            <div class="bt-main-grid bt-tour-grid">
                <div class="bt-calendar-section">
                    <div class="bt-section-header">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" width="20" height="20">
                            <rect x="3" y="4" width="18" height="18" rx="2" ry="2"></rect>
                ...
                <div class="bt-tour-info-section">
                    <div class="bt-section-header">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" width="20" height="20">
                            <circle cx="12" cy="12" r="10"></circle>
                            <line x1="12" y1="16" x2="12" y2="12"></line>
